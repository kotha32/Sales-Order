...
/**
 * Imports view extesnions of a page
 * @param {object} viewExtensionsOfPage
 * @param {string} targetKeyEntitySet
 * @param {LROPConfigsType} config
 * @param {CommonImportParameters} importParameters
 */
function processViewExtensions(viewExtensionsOfPage, targetKeyEntitySet, config, importParameters) {
 ...
 */
function addFragments(config, importParameters, v2Page, pageType, objectPageSectionData) {
    ...
    if (importParameters.manifest[ux_specification_types_1.ManifestSection.ui5]?.extends?.extensions?.['sap.ui.viewExtensions']) {
        ...
        processViewExtensions(viewExtensionsOfPage, targetKeyEntitySet, config, importParameters);
    }
}
/**
